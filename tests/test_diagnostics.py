...
async def test_diagnostics(hass: HomeAssistant) -> None:
    ...
    coordinator.client.available_keys = {"outdoor_temp", "heating_power"}
    ...
    assert "outdoor_temp" in result["signals"]["available"]
...
async def test_diagnostics_no_data(hass: HomeAssistant) -> None:
    ...
    coordinator.client.available_keys = set()
...
async def test_diagnostics_no_interval(hass: HomeAssistant) -> None:
    ...
    coordinator.client.available_keys = {"outdoor_temp"}
