...
def test_entity_device_info(coordinator_data: dict[str, Any]) -> None:
...
def test_entity_device_info_minimal() -> None:
...
def test_entity_available(coordinator_data: dict[str, Any]) -> None:
...
def test_entity_not_available_when_no_data(coordinator_data: dict[str, Any]) -> None:
...
def test_entity_not_available_when_key_missing(coordinator_data: dict[str, Any]) -> None:
...
def test_entity_not_available_when_update_failed(coordinator_data: dict[str, Any]) -> None:
